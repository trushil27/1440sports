# 1440 INTELLIGENCE BRIEF — Cyera  (N° ADHOC)
*AI Data Security (DSPM / trust layer for AI) · New York, NY · Private ($12B; Series G Jun 2026; AI data security) · 2026-06-16*
...
- **>$1.7B** — Total raised (>$1.7B), ~1,500 employees in 18 countries
- **Yotam Segev** — CEO & co-founder (ex-Israeli Unit 8200)
- **Naveen Palavalli** — CMO (decision-maker)
- **trust layer for enterprise AI** — Positioning
...
MODE A, real mechanics. (1) TECHNICAL: an F1 team's crown jewels are its design IP and its sponsor/finance data; Cyera's DSPM/data-security platform discovers, classifies and protects that sensitive data across the team's cloud and AI tools - a genuine, deployable protection workstream and a flagship 'securing the data that wins' reference, and for greenfield Cadillac it can be stood up from day one. (2) COMMERCIAL / B2B: Cyera sells to CISOs and CDOs, and the F1 paddock is dense with those enterprise buyers - hospitality becomes a pipeline, while Cadillac gains a $12B blue-chip security anchor. (3) BRAND / TALENT: 'the trust layer for the AI era' is an ownable co-marketing story, with a security-engineering talent halo. Cadillac gets real data protection; Cyera gets a live reference and a premium B2B stage.

## DEAL ARCHITECTURE
Official Data-Security Partner on the Cadillac F1 Team, minimum three years, ~$3-5M/yr, with a working DSPM deployment protecting the team's IP and data (data-security posture lane, distinct from endpoint/identity).
...
- **Capacity 18/20** — $12B valuation, >$1.7B raised - easily funds a top-tier partnership.
- **Brand Fit 14/20** — Cybersecurity is contested on the grid (CrowdStrike/Mercedes endpoint, Cisco/McLaren network, Keeper/Williams identity), but Cyera's DSPM/data-posture lane is distinct, and Cadillac lists cybersecurity as an explicitly open category as a greenfield team.
- **Urgency 14/20** — Post-raise brand momentum and the enterprise-AI security land-grab, but no dated competitor trigger in F1.
...
## SOURCES
- https://www.businesswire.com/news/home/20260610121080/en/
- https://fintech.global/2026/06/11/600m-raise-propels-cyera-to-ai-security-leadership/
- https://www.crunchbase.com/person/yotam-segev-9f92
- https://www.cohesity.com/newsroom/press/cohesity-expands-data-security-portfolio-with-cyera-dspm/
